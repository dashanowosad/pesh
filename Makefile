...
bin/prog: $(OBJECTS) bin
	$(CXX) $(FLAGS) $(OBJECTS) -o bin/prog

build/main.o: scr/main.c scr/functions.h build
	$(CXX) $(CFLAGS) scr/main.c  -o build/main.o

build/p_forward.o: scr/p_forward.c scr/functions.h build
	$(CXX) $(CFLAGS) scr/p_forward.c -o build/p_forward.o

build/p_hack.o: scr/p_hack.c scr/functions.h build
...
build/rook.o: scr/rook.c scr/functions.h build
	$(CXX) $(CFLAGS) scr/rook.c -o build/rook.o

build/Rook.o: scr/Rook.c scr/functions.h build
	$(CXX) $(CFLAGS) scr/Rook.c -o build/Rook.o

build/horse.o: scr/horse.c scr/functions.h build
	$(CXX) $(CFLAGS) scr/horse.c -o build/horse.o

build/Horse.o: scr/Horse.c scr/functions.h build
	$(CXX) $(CFLAGS) scr/Horse.c -o build/Horse.o

build/elephant.o: scr/elephant.c scr/functions.h build
	$(CXX) $(CFLAGS) scr/elephant.c -o build/elephant.o

build/Elephant.o: scr/Elephant.c scr/functions.h build
	$(CXX) $(CFLAGS) scr/Elephant.c -o build/Elephant.o

build/king.o: scr/king.c scr/functions.h build
	$(CXX) $(CFLAGS) scr/king.c -o build/king.o

build/King.o: scr/King.c scr/functions.h build
	$(CXX) $(CFLAGS) scr/King.c -o build/King.o

build/queen.o: scr/queen.c scr/functions.h build
...
bin/prog_test: $(OB) bin
	$(CXX) $(FLAGS) $(OB) -o bin/prog_test

build/main_test.o: test/main.c thirdparty/ctest.h scr/functions.h build
